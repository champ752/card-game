...
def open_a_card(board_row: int = Path(..., ge=0, lt=BOARD_ROW,description="row of the board index (2d array index) start with 0 not more than " + str(BOARD_ROW)),
                board_col: int = Path(..., ge=0, lt=BOARD_COL,description="col of the board index (2d array index) start with 0 not more than " + str(BOARD_COL)),
